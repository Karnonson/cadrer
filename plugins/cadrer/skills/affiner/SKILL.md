...
Done when the frontier is empty and the day holds. Then write `decisions.md` beside it with exactly these headings: **Décidé** — table: question · answer · why they chose it; **Supposé** — anything you filled in yourself, marked as such; **Abandonné** — what the interview cut, and why. Re-read once for anything vague or two-readable, fix in place, report what changed. Stop; do not offer to spec or build.
